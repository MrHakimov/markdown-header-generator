1. [What does --i and i-- mean? Is it better to do i++ or ++i? Well, let's discuss](#what-does---i-and-i---mean-is-it-better-to-do-i-or-i-well-lets-discuss)
2. [These are some special characters -= >. , /?](#these-are-some-special-characters-----)
3. [Programming languages: C--](#programming-languages-c--)

# What does --i and i-- mean? Is it better to do i++ or ++i? Well, let's discuss
